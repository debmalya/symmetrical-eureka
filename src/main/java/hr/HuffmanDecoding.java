...
// TODO encode hello! decoded value ?
// TODO encode HackerRank 
// TODO encode ThisIsHuffmanEncoding
	 */
	public static void decode(String S ,Node root)
    {
		 StringBuilder sb = new StringBuilder();
	        ...
	        for (int i = 0; i < S.length(); i++){
	            ...
	            if (root == null || c == '1') {
	            	if (root == null && c == '1'){
	            		sb.append(mainRoot.right.data);
	                     
	            	}
	            	root = mainRoot;
	               // System.out.println("Assigned to root ");
